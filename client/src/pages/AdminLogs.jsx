...
export default function AdminLogs() {
  ...
  const loadLogs = async () => {
    try {
      setLoading(true);
      setError('');
      const res = await api.get('/admin/admin-logs', { params: { limit: 300 } });
  ...
  return (
    <>
      ...
      <div className="content-wrapper" style={{ marginTop: '60px', padding: '30px', backgroundColor: '#fff', minHeight: 'calc(100vh - 60px)' }}>
        <h2 className="text-2xl fw-bold mb-4">Admin Logs</h2>
        ...
        <div className="bg-white rounded-4 shadow-lg overflow-hidden" style={{ borderRadius: '16px' }}>
          ...
          <div className="p-0">
            {loading ? (
              ...
              <div className="p-4 text-muted">No admin logs found</div>
            ) : (
