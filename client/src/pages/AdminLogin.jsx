          ...
          <div className="card-body">
            ...
            <div className="login-remember-row">
              <div className="form-check login-remember-check">
                ...
                />
                <label className="form-check-label login-remember-label" htmlFor="adminRememberMe">
                  Remember me
                </label>
              </div>
              <Link to="/admin/forgot-password" className="text-decoration-none login-remember-link">
                Forgot Password?
              </Link>
            </div>
